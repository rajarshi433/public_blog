                    ...
                    <div className="text-2xl grid grid-cols-10 gap-4 md:gap-6 max-w-fit rounded-md col-span-10">
                        ...
                        <div className='md:p-2 md:col-span-7 col-span-6 h-full flex flex-col w-full text-black text-base'>
                            ...
                            <Link to={`/profile/${data.createdBy._id}`}>
                                <span className='flex items-center'>
                                    <img
                                        ...
                                        src={data.createdBy.photoURL ? data.createdBy.photoURL : data.photoURL}
                                        alt="user photo"
                                    />
                                    <p className='text-sm font-bold ml-2 font-Ubuntu text-gray-700'>{data.createdBy.displayName ? data.createdBy.displayName : data.displayName}</p>
                                </span>
                            </Link>
                            ...
                            <span className='flex justify-between my-3 '>
                                ...
                                {
                                    isDeleted ? <p className='text-sm text-gray-500 font-bold text-center'>Post <br /> Deleted</p> : <RiDeleteBin6Line onClick={deleteHandler} className='text-xl cursor-pointer mr-2' ></RiDeleteBin6Line>
                                }
                            </span>
                        </div>
                    </div>
