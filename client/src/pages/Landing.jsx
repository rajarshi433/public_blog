                ...
                <section className=" lg:bg-none dark:bg-gray-900 mx-3 flex items-center">
                    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            ...
                            <p className="max-w-2xl mb-6 font-bold text-lg text-black lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 font-Josefin-Sans">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laboriosam at repudiandae aut blanditiis debitis id cum mollitia</p>
